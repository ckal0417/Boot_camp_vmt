...
CREATE TABLE Users (
	UserId INT IDENTITY(1,1) NOT NULL DEFAULT NEWID(),
...
CREATE TABLE CollectionsItems(
	...
	CONSTRAINT PK_CollestionsItems_CollestionId_ItemId PRIMARY KEY (CollectionId, ItemId)
);
...
DECLARE @ColeectionId UNIQUEIDENTIFIER ='54211901-34C2-42A9-88FA-34B708C7ABD'
